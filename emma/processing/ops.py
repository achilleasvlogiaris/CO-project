...
def aitrain(self, training_trace_set_paths, validation_trace_set_paths, conf):
    ...
    if conf.tfold:  # Train t times and generate tfold rank summary
        model.train_t_fold(training_iterator, validation_iterator, batch_size=conf.batch_size, epochs=conf.epochs, num_train_traces=45000, t=10, rank_trace_step=10, conf=conf)
